...
test_dataset = Date_Loader(path="/home/yijiahe/you/dataset/wire_paper_c2/label.txt",train_flag = False)#####测试数据集的地址
...
net.load_state_dict(torch.load('/home/yijiahe/you/garbage_c4/wire_paper_c2/mobile_best_299_train_acc_99.72682_test_acc_99.70352_loss_0.24565126.pth'))     ## 加载resnet18 模型
