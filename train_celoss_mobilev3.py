...
train_dataset = Date_Loader(path = "/home/yijiahe/you/dataset/cls9_1/train.txt") 
...
test_dataset = Date_Loader(path = "/home/yijiahe/you/dataset/cls9_1/val.txt",train_flag = False)
...
if __name__ == '__main__':
    ...
    for epoch in tqdm(range(epochs)):
        ...
        if (epoch % 10 == 0) or (epoch >= (epochs - 30)):
            ...
            torch.save(net.state_dict(), "./weight_c9/train_celoss_mobilev3/k_fold_1/mobile_best_%s_train_acc_%s_test_acc_%s_loss_%s.pth" % (epoch, train_acc.cpu().detach().numpy(), test_acc.cpu().detach().numpy(), (test_loss.sum() / test_total).cpu().detach().numpy()))
